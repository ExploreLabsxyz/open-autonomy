<a name="packages.valory.contracts.gnosis_safe.contract"></a>
# packages.valory.contracts.gnosis`_`safe.contract

This module contains the class to connect to an Gnosis Safe contract.

<a name="packages.valory.contracts.gnosis_safe.contract.checksum_address"></a>
#### checksum`_`address

```python
checksum_address(agent_address: str) -> ChecksumAddress
```

Get the checksum address.

<a name="packages.valory.contracts.gnosis_safe.contract.SafeOperation"></a>
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract"></a>
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_raw_transaction"></a>
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_raw_message"></a>
#### get`_`raw`_`message
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_state"></a>
#### get`_`state
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_deploy_transaction"></a>
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.verify_contract"></a>
#### verify`_`contract

```python
 | @classmethod
 | verify_contract(cls, ledger_api: LedgerApi, contract_address: str) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.revert_reason"></a>
#### revert`_`reason

```python
 | @classmethod
 | revert_reason(cls, ledger_api: EthereumApi, contract_address: str, tx: TxData) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_safe_nonce"></a>
#### get`_`safe`_`nonce

```python
 | @classmethod
 | get_safe_nonce(cls, ledger_api: EthereumApi, contract_address: str) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_ingoing_transfers"></a>
#### get`_`ingoing`_`transfers

```python
 | @classmethod
 | get_ingoing_transfers(cls, ledger_api: EthereumApi, contract_address: str, from_block: Optional[str] = None, to_block: Optional[str] = "latest") -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_balance"></a>
#### get`_`balance

```python
 | @classmethod
 | get_balance(cls, ledger_api: EthereumApi, contract_address: str) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_amount_spent"></a>
#### get`_`amount`_`spent

```python
 | @classmethod
 | get_amount_spent(cls, ledger_api: EthereumApi, contract_address: str, tx_hash: str) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_safe_txs"></a>
#### get`_`safe`_`txs

```python
 | @classmethod
 | get_safe_txs(cls, ledger_api: EthereumApi, contract_address: str, from_block: BlockIdentifier = "earliest", to_block: BlockIdentifier = "latest") -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_removed_owner_events"></a>
#### get`_`removed`_`owner`_`events

```python
 | @classmethod
 | get_removed_owner_events(cls, ledger_api: EthereumApi, contract_address: str, removed_owner: Optional[str] = None, from_block: BlockIdentifier = "earliest", to_block: BlockIdentifier = "latest") -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_zero_transfer_events"></a>
#### get`_`zero`_`transfer`_`events

```python
 | @classmethod
 | get_zero_transfer_events(cls, ledger_api: EthereumApi, contract_address: str, sender_address: str, from_block: BlockIdentifier = "earliest", to_block: BlockIdentifier = "latest") -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_remove_owner_data"></a>
#### get`_`remove`_`owner`_`data

```python
 | @classmethod
 | get_remove_owner_data(cls, ledger_api: EthereumApi, contract_address: str, owner: str, threshold: int) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_swap_owner_data"></a>
#### get`_`swap`_`owner`_`data

```python
 | @classmethod
 | get_swap_owner_data(cls, ledger_api: EthereumApi, contract_address: str, old_owner: str, new_owner: str) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_owners"></a>
#### get`_`owners

```python
 | @classmethod
 | get_owners(cls, ledger_api: EthereumApi, contract_address: str) -> JSONLike
```
...
<a name="packages.valory.contracts.gnosis_safe.contract.GnosisSafeContract.get_approve_hash_tx"></a>
#### get`_`approve`_`hash`_`tx

```python
 | @classmethod
 | get_approve_hash_tx(cls, ledger_api: EthereumApi, contract_address: str, tx_hash: str, sender: str) -> JSONLike
```
