<a name="plugins.aea-test-autonomy.aea_test_autonomy.fixture_helpers"></a>
...
<a name="plugins.aea-test-autonomy.aea_test_autonomy.fixture_helpers.UseTendermint.abci_host"></a>
#### abci`_`host
